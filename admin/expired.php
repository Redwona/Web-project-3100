    ...
    if(isset($_SESSION['login_user']))
      ...
      <div class="srch" >
       ...
       if(isset($_POST['submit']))
        {
           $res=mysqli_query($db,"SELECT * FROM `book_issue` where userid='$_POST[userid]' and bkid='$_POST[bkid]' ;");
        ...
        while($row=mysqli_fetch_assoc($res))
         ...
         if($diff>=0)
         {
          ...
          $x= date("Y-m-d"); 
          mysqli_query($db,"INSERT INTO `fine` VALUES ('$_POST[userid]', '$_POST[bkid]', '$x', '$day', '$fine','not paid') ;");

        $var1='<p style="color:yellow; background-color:green;">RETURNED</p>';
        mysqli_query($db,"UPDATE book_issue SET approve='$var1' where userid='$_POST[userid]' and bkid='$_POST[bkid]'");
        
        mysqli_query($db,"UPDATE `books` SET quantity = quantity+1 where bkid='$_POST[bkid]' ");
        }
      }
