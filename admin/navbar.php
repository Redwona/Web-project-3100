         ...
         <?php
                ...
                <ul class="nav navbar-nav navbar-right">
                  <li><a href="profile.php">
                    <div style="color: white">
                      <?php
                        echo "<img class='img-circle profile_img' height=40 width=40  src='images/".$_SESSION['picu']."'>";
            ...
            {   ?>
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="admin_login.php"><span class="glyphicon glyphicon-log-in"> SIGNIN</span></a></li>
