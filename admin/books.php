 ...
 <div class="srch">
    ...
    <form class="navbar-form" method="post" name="form1">
      <input class="form-control" type="text" name="bkid" placeholder="Enter Book ID" required="">
        <button style="background-color: darkred;color: white;" type="submit" name="submit1" class="btn btn-default">Delete
        </button>
    </form>
  </div>
   ...
   if(isset($_POST['submit1']))
    {
      if(isset($_SESSION['login_user']))
      {
        mysqli_query($db,"DELETE from books where bkid = '$_POST[bkid]'; ");
        ?>
