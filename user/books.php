...
<body>
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
        ...
        <div style="color: white; margin-left: 40px; font-size: 24px;">
  ...
  <div class="h"> <a href="bookissueinfo.php">Book Issue Info</a></div>
...
function closeNav() {
 ...
 <div class="srch">
    <form class="navbar-form" method="post" name="form1">
        ...
        <input class="form-control" type="text" name="bkid" placeholder="Enter Book ID" required="">
        <button style="background-color: lightskyblue;" type="submit1" name="submit1" class="btn btn-default">Request
        </button>
    </form>
  </div>
  ...
  <?php
    ...
    {
      $q=mysqli_query($db,"SELECT * from `books` where bktitle like '%$_POST[search]%' ");

      if(mysqli_num_rows($q)==0)
      {
        echo "Found Nothing! Try again please...";
      }
      else
      {
    echo "<table class='table table-bordered table-hover' >";
      echo "<tr style='background-color: #6db6b9e6;'>";
        ...
        echo "<th>"; echo "Copies_Owned";  echo "</th>";
   ...
   if(isset($_POST['submit1']))
    {
      if(isset($_SESSION['login_user']))
      {
        mysqli_query($db,"INSERT INTO `book_issue` Values('$_SESSION[login_user]', '$_POST[bkid]', '', '', '');");
         ?>
