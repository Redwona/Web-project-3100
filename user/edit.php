...
<body style="background-color: #16341c;">
	...
	<?php
		...
		$sql = "SELECT * FROM userr WHERE userid='$_SESSION[login_user]'";
	...
	<div class="form1">
		...
		<input class="form-control" type="text" name="userid" value="<?php echo $userid; ?>">
 
		<label><h4><b>Password</b></h4></label>
		<input class="form-control" type="text" name="password" value="<?php echo $password; ?>">

		<label><h4><b>Roll No</b></h4></label>
		<input class="form-control" type="number" name="roll" value="<?php echo $roll; ?>">
        
        <label><h4><b>Current Year</b></h4></label>
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$picus=$_FILES['file']['name'];

			$sql1= "UPDATE userr SET picus='$picus', first='$first', last='$last', userid='$userid', password='$password', roll='$roll',year='$year',email='$email', contact='$contact',joindate='$joindate' WHERE userid='".$_SESSION['login_user']."';";
