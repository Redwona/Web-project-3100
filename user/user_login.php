   ...
   <br><br><br><br><br>
    <div class="show1">
     ...
     <form name="login" action="" method="post">
        ...
        <p style="color: yellowgreen; font-size: 15px; ;">
        Not registered yet?<a style="color: white;" href="registration.php">Sign Up</a><br><br><br>
...
<?php
    ...
    {
      $count=0;
      $res=mysqli_query($db,"SELECT * FROM `userr` WHERE userid='$_POST[userid]' && password='$_POST[password]';");
