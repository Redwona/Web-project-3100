...
<div class="container">
	...
	if(isset($_SESSION['login_user']))
		{
			$q=mysqli_query($db,"SELECT bkid,approve,issuedate,returndate from `book_issue` where userid='$_SESSION[login_user]' and approve='' ;");
		...
		else
		{
			echo "</br></br></br>"; 
			echo "<h2><b>";
			echo " Please login first to know the request information.";
			echo "</b></h2>";
		}
		?>
	</div>
